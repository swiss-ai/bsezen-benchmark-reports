...
- [Apertus-8B: SwissAI API overhead](./apertus8b-api-overhead/report.md) - June 2026
...
- `data/` - Copied raw SQLite DBs used by the report
- `launch-scripts/` - Exact launch scripts used for served models
